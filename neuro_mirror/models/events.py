...
class Topics:
    ...
    REQ_GM02_START = "req.game.gm02.start"
    RESP_GM02_START = "resp.game.gm02.start"
    REQ_GM02_ANSWER = "req.game.gm02.answer"
    RESP_GM02_ANSWER = "resp.game.gm02.answer"
    REQ_GM07_START = "req.game.gm07.start"
    RESP_GM07_START = "resp.game.gm07.start"
    REQ_GM07_ANSWER = "req.game.gm07.answer"
    RESP_GM07_ANSWER = "resp.game.gm07.answer"
    REQ_GM14_START = "req.game.gm14.start"
    RESP_GM14_START = "resp.game.gm14.start"
    REQ_GM14_ANSWER = "req.game.gm14.answer"
    RESP_GM14_ANSWER = "resp.game.gm14.answer"
    REQ_GM17_START = "req.game.gm17.start"
    RESP_GM17_START = "resp.game.gm17.start"
    REQ_GM17_ANSWER = "req.game.gm17.answer"
    RESP_GM17_ANSWER = "resp.game.gm17.answer"
    REQ_GM20_START = "req.game.gm20.start"
    RESP_GM20_START = "resp.game.gm20.start"
    REQ_GM20_ANSWER = "req.game.gm20.answer"
    RESP_GM20_ANSWER = "resp.game.gm20.answer"
