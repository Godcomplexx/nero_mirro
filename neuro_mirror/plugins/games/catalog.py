...
GAME_CATALOG: tuple[GameDefinition, ...] = (
    ...
    GameDefinition("GM-08", "gm08_stop_signal", "Стоп-сигнал", (D.ATTENTION, D.ABSTRACTION),
    ...
    GameDefinition("GM-11", "gm11_serial_count", "Серийный счёт вслух", (D.ATTENTION, D.MEMORY, D.ABSTRACTION),
    ...
    GameDefinition("GM-16", "gm16_phonemic_fluency", "Фонемная вербальная беглость", (D.SPEECH, D.ATTENTION, D.MEMORY, D.ABSTRACTION),
                   ("phonemic_fluency",), (M.VISUAL, M.AUDITORY), R.SPOKEN,
                   ("буквы с высокой частотностью слов",), "", (), ("L04",), ("L05", "L06", "L08", "L09", "U06")),
    GameDefinition("GM-17", "gm17_mental_rotation", "Поверни фигуру", (D.ABSTRACTION, D.ATTENTION),
    ...
    GameDefinition("GM-18", "gm18_puzzle", "Пазлы", (D.ABSTRACTION, D.ATTENTION),
    ...
    GameDefinition("GM-19", "gm19_maze", "Лабиринт", (D.ABSTRACTION, D.ATTENTION, D.MEMORY),
                   ("maze_tracing", "route_planning"), (M.VISUAL,), R.POINTER,
                   ("геометрический лабиринт",), "размер лабиринта", (), ("V02", "U08"), ("E03", "E04", "V03", "U06")),
    GameDefinition("GM-20", "gm20_rule_sorting", "Сортировка по правилу", (D.ABSTRACTION, D.ATTENTION, D.MEMORY),
                   ("rule_sorting", "rule_switching"), (M.VISUAL,), R.CLICK,
                   ("цвет, форма и количество",), "частота смены правил", (), ("U01",), ("E06", "E07", "E05", "U06")),
    GameDefinition("GM-21", "gm21_odd_one_out", "Лишний предмет", (D.ABSTRACTION, D.MEMORY, D.ATTENTION),
                   ("odd_one_out", "categorisation"), (M.VISUAL,), R.CLICK,
                   ("животные", "продукты", "инструменты"), "смена категорий и очевидность признака", (),
                   ("U01",), ("G03", "U07", "U06")),
    GameDefinition("GM-22", "gm22_tower", "Башня / перестановка фигур", (D.ABSTRACTION, D.MEMORY, D.ATTENTION),
    ...
    GameDefinition("GM-23", "gm23_matrix_reasoning", "Продолжи закономерность", (D.ABSTRACTION, D.ATTENTION),
                   ("matrix_reasoning", "pattern_completion"), (M.VISUAL,), R.CLICK,
                   ("звезда", "треугольник", "сердце"), "количество схожих вариантов", (),
                   ("U01",), ("G03", "U07", "U06")),
    GameDefinition("GM-24", "gm24_category_naming", "Категориальное называние", (D.ABSTRACTION, D.SPEECH, D.MEMORY),
